...
def capture_speech():
    ...
    while True:
        ...
        try:
            ...
            print("Sorry, I couldn't catch that. Please say it again!")
...
def continue_story(prompt_text, ongoing_story, api_key):
    ...
    payload = {
        "contents": [
            {
                "parts": [
                    {"text": f"{ongoing_story} Continue this fun, interactive children story with another 50 words with the option {prompt_text}. In the end, ask me again how I want to continue the story by giving me 3 word options."}
                ]
            }
        ]
    }
