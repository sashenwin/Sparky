...
def generate_story(prompt_text, api_key):
    ...
    payload = {
        "contents": [
            {
                "parts": [
                    {"text": f"Generate a fun, interactive children story of about 50 words about {prompt_text}. In the end ask me how i want to continue the story by giving me 3 options"}
                ]
            }
        ]
    }
